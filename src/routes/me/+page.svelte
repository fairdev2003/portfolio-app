...
<div class="col-span-2 flex flex-col gap-y-5">
	<Box className=" w-full overflow-hidden break-words">
		...
		<p>
			...
			drodze zapominam wielu rzeczy. Już nie pamiętam, kiedy ostatni raz zrobiłem sobie śniadanie.
			Moje życie to ciągły chaos. Mam tyle rzeczy w głowie, a wcale dużo nie robię. Od jakiegoś
			czasu mierzę się z kompletnym brakiem motywacji. Czuję się sam z tymi wszystkimi problemami.
			Mam ogromne wahania nastroju - raz jestem radosny, a w zasadzie przez większość czasu jestem
			albo zdenerwowany, albo pusty lub smutny. Nie jestem pewny, czy to depresja - raczej zakładam,
			że jest to wszystko spowodowane tym jednym problemem, czyli w zasadzie moją chorobą. Odkąd
			dowiedziałem się o tym, totalnie nie umiem się z tym pogodzić. Po drodze, aby nie zwariować,
			zacząłem bawić się w robienie stron internetowych. Przez dłuższy okres uciekałem w to i dawało
			mi to ogólną satysfakcję, ale od jakiegoś czasu kompletnie mnie to nie cieszy - jakbym już
			zapomniał, jak się to robi, ale to nieprawda. Często siedzę przed monitorem i kompletnie nie
			wiem, co mam ze sobą zrobić. Jak się już tak dzieje - to zamiast pójść spać, to idę chodzić po
			Krakowie w jakimś amoku. Czuję się nieszczęśliwy w tym wszystkim. Mimo różnych myśli mam
			nadzieję, że jakiś lekarz mi powie, że wszystko jest okej, że mogę się rozwijać, ale raczej
			tak się nigdy nie stanie. Żyję z dnia na dzień. Nie mam kompletnie żadnych planów. Boję się,
			że będzie tak zawsze. Że zawsze będę nieszczęśliwy. Często przez te wahania nastroju nie wiem,
			kim jestem - jakby przez tę chorobę ktoś zabrał cząstkę mnie. Czuję się jak gorszy model,
			który nie zasługuje na miłość. Wracając z pracy, chciałbym się rozwijać, ale po prostu ze
			względu na moją przypadłość nie mogę. Czuję się z każdym dniem coraz bardziej słaby. Bardzo
			się cieszę, że ostatnio pojawiła się w moim życiu jedna osoba, która chce mi pomóc. Jestem
			wrażliwą osobą i naprawdę się wzruszyłem, jak ta osoba specjalnie do mnie przyjechała, mimo
